...
*******************************************************************************
*                   Table 5 IV Regression Second Stage                        *
*******************************************************************************
...
eststo: ivreg2 d2_投票率 (log_Events_Count_1124 = `Instrument') $Demo $Origin $Education $Employment $Income i.dc_class_f, r
qui estadd local Demographics "Y"
qui estadd local Employment "Y"	
qui estadd local Income "Y"	
qui estadd local District "Y"
...
eststo: ivreg2 d2_投票率 (log_Events_Count_1124 = `Instrument') $Demo $Origin $Education $Employment $Income i.dc_class_f [aw=t_pop_2016], r
qui estadd local Demographics "Y"
qui estadd local Employment "Y"	
qui estadd local Income "Y"		
qui estadd local Weight "2016 pop"
...
eststo: ivreg2 d2_投票率_lag (log_Events_Count_1124 = `Instrument') $Demo $Origin $Education $Employment $Income i.dc_class_f, r
qui estadd local Demographics "Y"
qui estadd local Employment "Y"	
qui estadd local Income "Y"	
qui estadd local District "Y"
...
eststo: ivreg2 d2_投票率_lag (log_Events_Count_1124 = `Instrument') $Demo $Origin $Education $Employment $Income i.dc_class_f [aw=t_pop_2016], r
qui estadd local Demographics "Y"
qui estadd local Employment "Y"	
qui estadd local Income "Y"		
qui estadd local Weight "2016 pop"
...
esttab using "$output/Final Tables/Table 5 IV Second Stage.tex", replace f ///
...
mgroups("\( \Delta Turnout_{2019-2015} \)" "\( \Delta Turnout_{2015-2011} \)", pattern(1 0 0 0 1 0) ///
